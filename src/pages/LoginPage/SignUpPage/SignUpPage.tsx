...
//             required
//           />
//           {nameError.length > 0 && <span className={styles.Login_label_errorMessage}>{nameError}</span>}
//         </div>
...
//         {emailError.length > 0 && <span className={styles.Login_label_errorMessage}>{emailError}</span>}
//         </div>
...
//               src={showPassword ? (passwordError ? redEye : eye) : (passwordError ? redEyeClose : eyeClose)}
